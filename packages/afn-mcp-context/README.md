...
Cerebro: `.afn/memory/cerebro.json`. Mapa: inventario de disco + LLM que **no inventa** (evidencia → commit). Vista: `node index.js dashboard`. `setup kiro` escribe el MCP **en el workspace**.
