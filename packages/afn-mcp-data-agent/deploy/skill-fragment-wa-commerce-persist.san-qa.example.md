...
Caption («parte del pago» / «Valida» / «Abono») + media: el runtime **bloquea catálogo MCP**, OCR/Gmail. **PROHIBIDO** preguntar «¿cuánto abonaste?» o buscar la imagen en el workspace con `data_find`/`channel_media`.
